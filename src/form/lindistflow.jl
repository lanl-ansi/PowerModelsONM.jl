...
"""
constraint_mc_load_power_block_on_off(pm::PMD.AbstractUnbalancedPowerModel, load_id::Int; nw::Int=nw_id_default, report::Bool=true) = PMD.constraint_mc_load_power(pm, load_id; nw=nw, report=report)
...
```
"""
function constraint_mc_load_power_block_on_off(pm::PMD.LPUBFDiagModel, load_id::Int; nw::Int=nw_id_default, report::Bool=true)
    # shared variables and parameters
    load = ref(pm, nw, :load, load_id)
    connections = load["connections"]
    pd0 = load["pd"]
